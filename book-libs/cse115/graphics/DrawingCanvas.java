...
public class DrawingCanvas extends javax.swing.JPanel implements
	...
	/**
	 * Returns the first Graphic at p
	 */
	public Graphic getGraphic(java.awt.Point p) {
	...
	public Image makeImage(String imagePathAndName) {
		/* System classLoader is rooted at the default package.
		 * All resources are located relative to that location.
		 * imagePathAndName must not include "src/" or any other Eclipse project-specific 
		 * directory structure.
		 */
		URL url = ClassLoader.getSystemClassLoader().getResource(imagePathAndName);
		return Toolkit.getDefaultToolkit().getImage(url);
//		return null;
	}
	
	public Cursor makeCustomCursor(String imagePathAndName) {
		Image cursorImage = makeImage(imagePathAndName);
		Point cursorHotSpot = new Point(0,0);
		String name = imagePathAndName.substring(imagePathAndName.lastIndexOf('/')+1,imagePathAndName.indexOf('.'));
		return Toolkit.getDefaultToolkit().createCustomCursor(cursorImage, cursorHotSpot, name);
//		return new FakeCursor(imagePathAndName);
	}

	//	public Cursor makeCustomCursor(String imagePathAndName) {
//		String name = imagePathAndName.substring(imagePathAndName.lastIndexOf('/')+1,imagePathAndName.indexOf('.'));
//		Toolkit toolkit = Toolkit.getDefaultToolkit();
//		Image cursorImage = toolkit.getImage(imagePathAndName);
//		Point cursorHotSpot = new Point(0,0);
//		return toolkit.createCustomCursor(cursorImage, cursorHotSpot, name);
//	}
}
